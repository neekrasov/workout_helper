...
Revision ID: fd556cb2e56c
Revises: 
Create Date: 2023-01-16 16:54:01.318612
...
def upgrade() -> None:
    ...
    op.create_table('sports_grounds',
    ...
    op.create_table('liked_grounds',
    sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('ground_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['ground_id'], ['sports_grounds.id'], name='fk_ground_id', ondelete='CASCADE'),
